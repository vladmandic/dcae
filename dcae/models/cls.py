...
from ..models.backbone import EfficientViTBackbone, EfficientViTLargeBackbone
...
def efficientvit_cls_b0(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_b0
...
def efficientvit_cls_b1(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_b1
...
def efficientvit_cls_b2(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_b2
...
def efficientvit_cls_b3(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_b3
...
def efficientvit_cls_l1(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_l1
...
def efficientvit_cls_l2(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_l2
...
def efficientvit_cls_l3(**kwargs) -> EfficientViTCls:
    from .models.backbone import efficientvit_backbone_l3
